...
void MatrixMult(real8 *a, int aRows, int aCols, int aLD, real8 *b, int bCols,
                int bLD, real8 *c, int cLD);
void MatrixMultArb(real8 *a, int aCols, int aRowOffset, int aColOffset,
                   int aMultRows, int aMultCols, real8 *b, int bCols,
                   int bRowOffset, int bColOffset, int bMultCols, real8 *c,
                   int cCols, int cRowOffset, int cColOffset);
