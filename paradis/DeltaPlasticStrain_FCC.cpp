...
//  */
//
//         nanv[0][0][0]=0.5773502692; nanv[0][1][0]=-0.5773502692;
//         nanv[0][2][0]=0.5773502692; nanv[1][0][0]=-0.5773502692;
//         nanv[1][1][0]=0.5773502692; nanv[1][2][0]=0.5773502692;
//         nanv[2][0][0]=0.0000000000; nanv[2][1][0]=0.0000000000;
//         nanv[2][2][0]=1.0000000000;
//
//         nanv[0][0][1]=0.5773502692; nanv[0][1][1]=0.5773502692;
//         nanv[0][2][1]=0.5773502692; nanv[1][0][1]=0.5773502692;
//         nanv[1][1][1]=0.5773502692; nanv[1][2][1]=-0.5773502692;
//         nanv[2][0][1]=0.0000000000; nanv[2][1][1]=0.0000000000;
//         nanv[2][2][1]=1.0000000000;
//
//         nanv[0][0][2]=0.5773502692; nanv[0][1][2]=0.5773502692;
//         nanv[0][2][2]=-0.5773502692; nanv[1][0][2]=-0.5773502692;
//         nanv[1][1][2]=0.5773502692; nanv[1][2][2]=0.5773502692;
//         nanv[2][0][2]=0.0000000000; nanv[2][1][2]=1.0000000000;
//         nanv[2][2][2]=0.0000000000;
//
//         nanv[0][0][3]=0.5773502692; nanv[0][1][3]=0.5773502692;
//         nanv[0][2][3]=0.5773502692; nanv[1][0][3]=0.5773502692;
//         nanv[1][1][3]=-0.5773502692; nanv[1][2][3]=0.5773502692;
//         nanv[2][0][3]=0.0000000000; nanv[2][1][3]=1.0000000000;
//         nanv[2][2][3]=0.0000000000;
//
//         nanv[0][0][4]=0.5773502692; nanv[0][1][4]=0.5773502692;
//         nanv[0][2][4]=-0.5773502692; nanv[1][0][4]=0.5773502692;
//         nanv[1][1][4]=-0.5773502692; nanv[1][2][4]=0.5773502692;
//         nanv[2][0][4]=1.0000000000; nanv[2][1][4]=0.0000000000;
//         nanv[2][2][4]=0.0000000000;
//
//         nanv[0][0][5]=0.5773502692; nanv[0][1][5]=0.5773502692;
//         nanv[0][2][5]=0.5773502692; nanv[1][0][5]=-0.5773502692;
//         nanv[1][1][5]=0.5773502692; nanv[1][2][5]=0.5773502692;
//         nanv[2][0][5]=1.0000000000; nanv[2][1][5]=0.0000000000;
//         nanv[2][2][5]=0.0000000000;
//
//         tanv[0][0][0]=-0.4082482905; tanv[0][1][0]=0.4082482905;
//         tanv[0][2][0]=0.8164965809; tanv[1][0][0]=-0.4082482905;
//         tanv[1][1][0]=0.4082482905; tanv[1][2][0]=-0.8164965809;
//         tanv[2][0][0]=-0.7071067812; tanv[2][1][0]=0.7071067812;
//         tanv[2][2][0]=0.0000000000;
//
//         tanv[0][0][1]=0.4082482905; tanv[0][1][1]=0.4082482905;
//         tanv[0][2][1]=-0.8164965809; tanv[1][0][1]=-0.4082482905;
//         tanv[1][1][1]=-0.4082482905; tanv[1][2][1]=-0.8164965809;
//         tanv[2][0][1]=0.7071067812; tanv[2][1][1]=0.7071067812;
//         tanv[2][2][1]=-0.0000000000;
//
//         tanv[0][0][2]=0.4082482905; tanv[0][1][2]=-0.8164965809;
//         tanv[0][2][2]=-0.4082482905; tanv[1][0][2]=0.4082482905;
//         tanv[1][1][2]=0.8164965809; tanv[1][2][2]=-0.4082482905;
//         tanv[2][0][2]=0.7071067812; tanv[2][1][2]=0.0000000000;
//         tanv[2][2][2]=-0.7071067812;
//
//         tanv[0][0][3]=-0.4082482905; tanv[0][1][3]=0.8164965809;
//         tanv[0][2][3]=-0.4082482905; tanv[1][0][3]=0.4082482905;
//         tanv[1][1][3]=0.8164965809; tanv[1][2][3]=0.4082482905;
//         tanv[2][0][3]=-0.7071067812; tanv[2][1][3]=0.0000000000;
//         tanv[2][2][3]=-0.7071067812;
//
//         tanv[0][0][4]=0.8164965809; tanv[0][1][4]=-0.4082482905;
//         tanv[0][2][4]=0.4082482905; tanv[1][0][4]=-0.8164965809;
//         tanv[1][1][4]=-0.4082482905; tanv[1][2][4]=0.4082482905;
//         tanv[2][0][4]=0.0000000000; tanv[2][1][4]=-0.7071067812;
//         tanv[2][2][4]=0.7071067812;
//
//         tanv[0][0][5]=-0.8164965809; tanv[0][1][5]=0.4082482905;
//         tanv[0][2][5]=0.4082482905; tanv[1][0][5]=-0.8164965809;
//         tanv[1][1][5]=-0.4082482905; tanv[1][2][5]=-0.4082482905;
//         tanv[2][0][5]=-0.0000000000; tanv[2][1][5]=0.7071067812;
//         tanv[2][2][5]=0.7071067812;
//
//         bnorm[0][0]=0.7071067812; bnorm[0][1]=0.7071067812;
//         bnorm[0][2]=0.0000000000; bnorm[1][0]=0.7071067812;
//         bnorm[1][1]=-0.7071067812; bnorm[1][2]=0.0000000000;
//         bnorm[2][0]=0.7071067812; bnorm[2][1]=0.0000000000;
//         bnorm[2][2]=0.7071067812; bnorm[3][0]=0.7071067812;
//         bnorm[3][1]=0.0000000000; bnorm[3][2]=-0.7071067812;
//         bnorm[4][0]=0.0000000000; bnorm[4][1]=0.7071067812;
//         bnorm[4][2]=0.7071067812; bnorm[5][0]=0.0000000000;
//         bnorm[5][1]=0.7071067812; bnorm[5][2]=-0.7071067812;
//
//         burgv[0][0]=0.7071067812; burgv[0][1]=0.7071067812;
//         burgv[0][2]=0.0000000000; burgv[1][0]=0.7071067812;
//         burgv[1][1]=-0.7071067812; burgv[1][2]=0.0000000000;
//         burgv[2][0]=0.7071067812; burgv[2][1]=0.0000000000;
//         burgv[2][2]=0.7071067812; burgv[3][0]=0.7071067812;
//         burgv[3][1]=0.0000000000; burgv[3][2]=-0.7071067812;
//         burgv[4][0]=0.0000000000; burgv[4][1]=0.7071067812;
//         burgv[4][2]=0.7071067812; burgv[5][0]=0.0000000000;
//         burgv[5][1]=0.7071067812; burgv[5][2]=-0.7071067812;
//
...
//         {
//             if ((node = home->nodeKeys[iii]) == NULL)
//             {
//                 continue;
//             }
...
//                if (nbr == NULL)
//                {
//                    printf("WARNING: Neighbor not found at %s line
...
//
//                 //printf("-1,%d,%d,%d,%d,%d,%25.20f,%25.20f,%25.20f\n",home->myDomain,node->myTag.domainID,node->myTag.index,nbr->myTag.domainID,nbr->myTag.index,nx,ny,nz);
//                 //printf("@ %d : coords 1 :
//                 (%25.20f,%25.20f,%25.20f),(%25.20f,%25.20f,%25.20f)\n",home->myDomain,node->x,node->y,node->z,node->oldx,node->oldy,node->oldz);
//                 //printf("@ %d : coords 2 :
//                 (%25.20f,%25.20f,%25.20f),(%25.20f,%25.20f,%25.20f)\n",home->myDomain,nbr->x,nbr->y,nbr->z,nbr->oldx,nbr->oldy,nbr->oldz);
//            		//fflush(NULL);
//
...
//                   {
//                       dstn[l][k] += (dyad[l][k] +
//                       dyad[k][l])*0.5/param->simVol; dspn[l][k] +=
//                       (dyad[l][k] - dyad[k][l])*0.5/param->simVol;
//                   }
//                }
//             	//printf("-2,%d,%d,%d,%d,%d,%25.20f,%25.20f,%25.20f,%25.20f,%25.20f,%25.20f\n",home->myDomain,node->myTag.domainID,node->myTag.index,nbr->myTag.domainID,nbr->myTag.index,dstn[0][0],dstn[1][1],dstn[2][2],dstn[0][1],dstn[0][2],dstn[1][2]);
//             	//fflush(NULL);
//
//                /* Modified for flux decomposition calculation 06/22/04 M.Rhee
//                */ delxnode = node->x - node->oldx; delynode = node->y -
//                node->oldy; delznode = node->z - node->oldz;
//
...
//                zeta[2] = tmpz;
//
//                size=sqrt(zeta[0]*zeta[0] + zeta[1]*zeta[1] +
//                zeta[2]*zeta[2]);
//
// /*
...
//             }
//             for (j = 0; j < 7; j++) {
//                 param->FCC_dfluxtot[i][j] =
//                 areaSwept[i][j]/param->simVol/param->deltaTT;
//             }
//         }
//
//
