#ifndef FEMIMPLICITDYNAMICSSOLIDSOLVER_H_
#define FEMIMPLICITDYNAMICSSOLIDSOLVER_H_

#include "FEMSolver.h"

namespace FEMSystem
{
	class FEMImplicitDynamicsSolidSolver : public FEMSolver
	{
	public:
		FEMImplicitDynamicsSolidSolver();
		FEMImplicitDynamicsSolidSolver(const FEMImplicitDynamicsSolidSolver& oSolver);
		virtual ~FEMImplicitDynamicsSolidSolver();
		virtual FEMImplicitDynamicsSolidSolver& operator=(const FEMImplicitDynamicsSolidSolver& oSolver);
		virtual void Reset();
	...
	protected:
		...
		void PartitionMatrices(const SparseMatrix& oStiffnessMatrix,const SparseMatrix& oMassMatrix);
