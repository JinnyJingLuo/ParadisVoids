...
void DecodeDomainIdx(Home_t *home, int idx, int *iXdom, int *jYdom, int *kZdom);
...
void CSplint(real8 *xa, real8 *ya, real8 *y2, int numPoints, real8 x, real8 *y);
...
void GetPlaneNormFromPoints(real8 p1[3], real8 p2[3], real8 p3[3],
                            real8 normalVec[3]);
void GetUnitVector(int unitFlag, real8 vx0, real8 vy0, real8 vz0, real8 vx1,
                   real8 vy1, real8 vz1, real8 *ux, real8 *uy, real8 *uz,
                   real8 *disMag);
